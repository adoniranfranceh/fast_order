...
RSpec.describe 'Users', type: :request do
  describe 'PUT /api/v1/users/:id/activate' do
    ...
    it 'retorna erro de senha inválida com senha admin incorreta' do
      ...
      put activate_api_v1_user_path user, params: { admin_password: 'wrong_password', admin_id: admin.id }
    ...
    it 'retorna erro ao tentar desativar o usuário de outro admin' do
      ...
      put activate_api_v1_user_path user, params: { admin_password:, admin_id: other_admin.id }
